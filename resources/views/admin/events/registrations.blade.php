...
@section('page_title', 'Registrations for ' . $event->title)
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ route('admin.events.index') }}" class="btn btn-sm btn-default">
                    ...
                    <tbody>
                        @forelse($registrations as $registration)
                            <tr>
                                ...
                                <td>{{ $event->registration_fee > 0 ? '$' . $registration->amount : 'Free' }}</td>
                                <td>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center">No registrations found for this event.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
