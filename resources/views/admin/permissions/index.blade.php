        ...
        <div class="card card-outline card-primary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <form action="{{ route('admin.permissions.index') }}" method="GET" class="input-group input-group-sm" style="width: 250px;">
                        ...
                        <div class="input-group-append">
                            ...
                            @if(request('search'))
                                <a href="{{ route('admin.permissions.index') }}" class="btn btn-danger" title="Clear Search">
