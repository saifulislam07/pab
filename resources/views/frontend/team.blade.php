...
<div class="bg-gray-900 min-h-screen py-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16" x-data="{ shown: false }" x-intersect="shown = true" :class="{ 'opacity-0': !shown, 'opacity-100': shown }" class="transition duration-1000">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            @foreach([
                ...
                ['name' => 'Fatima Begum', 'role' => 'Secretary', 'img' => 'https://images.unsplash.com/photo-1494790108377-be9c29b29330'],
                ['name' => 'Kamal Hossain', 'role' => 'Treasurer', 'img' => 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e']
            ] as $member)
                <div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg group hover:-translate-y-2 transition duration-300"
                     ...
                     :class="{ 'opacity-0 translate-y-10': !shown, 'opacity-100 translate-y-0': shown }" class="transition duration-700">
                    <div class="relative h-80 overflow-hidden">
                        <img src="{{ $member['img'] }}?q=80&w=400&auto=format&fit=crop" class="w-full h-full object-cover transition duration-500 group-hover:scale-110">
