...
<div class="row">
    <div class="col-md-10 offset-md-1">
        <div class="card card-outline card-danger">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">To get started, please provide a few more details about yourself. This helps our community connect with you.</p>
                ...
                <form method="POST" action="{{ route('member.profile.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="permission">Allow my email and phone number to be visible on the public members list</label>
                        </div>
                    </div>
